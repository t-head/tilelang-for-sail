...
@tilelang.jit(out_idx=[3, 4, 5], verbose=False, pass_configs={PassConfigKey.TL_DISABLE_AIU_LOWER: False, PassConfigKey.TL_DISABLE_LDMAT_SWZL: False})
    ...
    def gemm(
        ...
        with T.Kernel(T.ceildiv(N, block_N), T.ceildiv(M, block_M), threads=thread_num) as (bx, by):
            ...
            for k in T.Pipelined(T.ceildiv(K, block_K), num_stages=1):
                ...
                T.gemm(D_local_cast, B_shared, E_local, transpose_B=True)
