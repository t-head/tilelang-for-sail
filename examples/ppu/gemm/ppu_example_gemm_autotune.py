...
def get_best_config(
    ...
    autotuner = (
        ...
        .set_compile_args(
            out_idx=[-1],
            target="auto",
            pass_configs={PassConfigKey.TL_DISABLE_AIU_LOWER: False, PassConfigKey.TL_DISABLE_LDMAT_SWZL: False},
        )
        .set_profile_args(
...
@tl.jit(out_idx=[-1], pass_configs={PassConfigKey.TL_DISABLE_AIU_LOWER: False, PassConfigKey.TL_DISABLE_LDMAT_SWZL: False})
