// PPU0010 sparse MMA extension (not available in upstream CUTLASS for sm8x)
#pragma once
...
#define CUTE_ARCH_SPARSE_MMA_PPU0010_ENABLED
#endif
...
struct PPU0010_16x8x16_F16F16F16F16_TN {
  ...
  CUTE_HOST_DEVICE static void fma(uint32_t &d0, uint32_t &d1,
    ...
    CUTE_INVALID_CONTROL_PATH("PPU0010_16x8x16_F16F16F16F16_TN requires "
                              "CUTE_ARCH_SPARSE_MMA_PPU0010_ENABLED");
#endif
  }
};
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x32_F16F16F16F16_TN {
  using DRegisters = uint32_t[2];
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x16_F32F16F16F32_TN {
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x32_F32F16F16F32_TN {
  using DRegisters = float[4];
  using ARegisters = uint32_t[4];
  using BRegisters = uint32_t[4];
  using CRegisters = float[4];
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x16_F32BF16BF16F32_TN {
  using DRegisters = float[4];
  using ARegisters = uint32_t[2];
  using BRegisters = uint32_t[2];
  using CRegisters = float[4];
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x32_F32BF16BF16F32_TN {
  using DRegisters = float[4];
  using ARegisters = uint32_t[4];
  using BRegisters = uint32_t[4];
  using CRegisters = float[4];
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x8_F32TF32TF32F32_TN {
  using DRegisters = float[4];
  using ARegisters = uint32_t[2];
  using BRegisters = uint32_t[2];
  using CRegisters = float[4];
...
template <SparseSel spsel = SparseSel::Zero>
struct PPU0010_16x8x16_F32TF32TF32F32_TN {
  using DRegisters = float[4];
  using ARegisters = uint32_t[4];
  using BRegisters = uint32_t[4];
  using CRegisters = float[4];
...
template <> struct PPU0010_16x8x32_S32S8S8S32_TN<SparseSel::One> {
  using DRegisters = uint32_t[4];
  using ARegisters = uint32_t[2];
  using BRegisters = uint32_t[2];
  using CRegisters = uint32_t[4];
  ...
  CUTE_HOST_DEVICE static void fma(uint32_t &d0, uint32_t &d1, uint32_t &d2,
    ...
    CUTE_INVALID_CONTROL_PATH(
        "PPU0010_16x8x32_S32S8S8S32_TN with SparseSel::One is invalid");
  }
};
...
template <> struct PPU0010_16x8x64_S32S8S8S32_TN<SparseSel::One> {
  using DRegisters = uint32_t[4];
  using ARegisters = uint32_t[4];
  using BRegisters = uint32_t[4];
  using CRegisters = uint32_t[4];
  ...
  CUTE_HOST_DEVICE static void fma(uint32_t &d0, uint32_t &d1, uint32_t &d2,
                                   ...
                                   uint32_t const &c3, uint32_t const &e) {
    CUTE_INVALID_CONTROL_PATH(
        "PPU0010_16x8x64_S32S8S8S32_TN with SparseSel::One is invalid");
  }
};
...
template <> struct PPU0010_16x8x32_S32U8U8S32_TN<SparseSel::One> {
  using DRegisters = uint32_t[4];
  using ARegisters = uint32_t[2];
  using BRegisters = uint32_t[2];
  using CRegisters = uint32_t[4];
  ...
  CUTE_HOST_DEVICE static void fma(uint32_t &d0, uint32_t &d1, uint32_t &d2,
                                   ...
                                   uint32_t const &c3, uint32_t const &e) {
    CUTE_INVALID_CONTROL_PATH(
        "PPU0010_16x8x32_S32U8U8S32_TN with SparseSel::One is invalid");
  }
};
...
template <> struct PPU0010_16x8x64_S32U8U8S32_TN<SparseSel::One> {
  using DRegisters = uint32_t[4];
  using ARegisters = uint32_t[4];
  using BRegisters = uint32_t[4];
  using CRegisters = uint32_t[4];
  ...
  CUTE_HOST_DEVICE static void fma(uint32_t &d0, uint32_t &d1, uint32_t &d2,
                                   ...
                                   uint32_t const &c3, uint32_t const &e) {
    CUTE_INVALID_CONTROL_PATH(
        "PPU0010_16x8x64_S32U8U8S32_TN with SparseSel::One is invalid");
  }
};
