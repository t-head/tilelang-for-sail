...
if __name__ == "__main__":
    ...
    main(args.batch, args.h, args.n_ctx, args.d_head, args.causal, False, block_M=args.block_M,
        block_N=args.block_N, num_stages=args.num_stages, threads=args.threads)
