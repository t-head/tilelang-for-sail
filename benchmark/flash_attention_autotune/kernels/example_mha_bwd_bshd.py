...
def flashattn_bwd(batch, heads, seq_len, dim, is_causal, block_M=64, block_N=64, num_stages=0, threads=128):
...
class _attention(torch.autograd.Function):
    ...
    def backward(ctx, do):
        ...
        kernel = flashattn_bwd(BATCH, H, N_CTX, D_HEAD, ctx.causal, cfg["block_M"], cfg["block_N"], cfg["num_stages"], cfg["threads"])
