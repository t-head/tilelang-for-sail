...
def main(
    ...
    if (not tune):
        ...
        kernel = flashattn(
            ...
            threads=threads)
        Q = (
            torch.empty(batch, heads, seq_q, dim, dtype=torch.half,
        ...
        best_kernel = flashattn(batch, heads, seq_q, seq_kv, dim, is_causal,
...
if __name__ == "__main__":
    ...
    main(args.batch, args.heads, args.seq_q, args.seq_kv, args.dim, args.causal, False,
