...
from tilelang.ppu.intrinsics import PPUTensorCoreIntrinEmitter
...
def tl_matmul(
    ...
    mma_emitter = PPUTensorCoreIntrinEmitter(
        a_dtype=in_dtype,
        b_dtype=in_dtype,
...
def get_configs(M, N, K, in_dtype, out_dtype, accum_dtype, with_roller, **kwargs):
    """
...
def matmul(
    ...
    block_row_warps = block_row_warps or 1
    block_col_warps = block_col_warps or 1
    warp_row_tiles = warp_row_tiles or 32
    warp_col_tiles = warp_col_tiles or 32
    chunk = chunk or 64
