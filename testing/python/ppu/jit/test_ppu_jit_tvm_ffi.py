...
def test_tvm_ffi_l2_persistent_map():
    ...
    assert "__tvm_ppu_stream_set_access_policy_window_packed" in source, (
        "Expected __tvm_ppu_stream_set_access_policy_window_packed in the kernel source"
    )
    assert "__tvm_ppu_stream_reset_access_policy_window_packed" in source, (
        "Expected __tvm_ppu_stream_reset_access_policy_window_packed in the kernel source"
    )
...
@tilelang.testing.requires_ppu
@tilelang.testing.requires_ppu_compute_version_gt(1, 5)
